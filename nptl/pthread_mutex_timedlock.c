...
#ifndef lll_timedlock_adaptive_hle 
#define lll_timedlock_adaptive_hle(a,dummy,b,c) lll_timedlock(a, b, c)
#endif
     ...
     const struct timespec *abstime;
{
  ...
  switch (__builtin_expect (PTHREAD_MUTEX_TYPE (mutex),
    ...
    case PTHREAD_MUTEX_HLE_ADAPTIVE_NP:
      ...
      return lll_timedlock_adaptive_hle (mutex->__data.__lock, 
