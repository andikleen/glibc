...
#ifndef lll_adaptive_unlock_hle
#define lll_adaptive_unlock_hle(a,b) ({ lll_unlock (a,b); 0; })
#endif
     ...
     int decr;
{
  ...
  if (__builtin_expect (type, PTHREAD_MUTEX_TIMED_NP)
  ...
  else if (__builtin_expect (type == PTHREAD_MUTEX_HLE_ADAPTIVE_NP, 1))
    {
      ...
      return lll_adaptive_unlock_hle (mutex->__data.__lock, 
	...
	return 0;
      goto normal;
	   ...
	   __builtin_expect (type == PTHREAD_MUTEX_TIMED_NONHLE_NP, 1))
    goto normal;
  else
    {
