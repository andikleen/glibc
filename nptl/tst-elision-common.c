...
mutex_test (void)
{
  ...
  ret += run_mutex_init (default_iter, "timed init default", 0, 0, 0);
...
rwlock_test (void)
{
  ...
  ret += run_rwlock_attr_set (0, "not eliding", PTHREAD_RWLOCK_NO_ELISION_NP, 2);
