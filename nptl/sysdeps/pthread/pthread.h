...
#  define PTHREAD_TIMED_ELISION_MUTEX_INITIALIZER_NP \
  { { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_ELISION_NP, 0, { 0, 0 } } }
#  define PTHREAD_TIMED_NO_ELISION_MUTEX_INITIALIZER_NP \
  { { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NO_ELISION_NP, 0, { 0, 0 } } }
# endif
#else
# define PTHREAD_MUTEX_INITIALIZER \
  { { 0, 0, 0, 0, 0, { 0 } } }
...
#  define PTHREAD_TIMED_ELISION_MUTEX_INITIALIZER_NP \
  { { 0, 0, 0, PTHREAD_MUTEX_TIMED_ELISION_NP, 0, { 0 } } }
#  define PTHREAD_TIMED_NO_ELISION_MUTEX_INITIALIZER_NP \
  { { 0, 0, 0, PTHREAD_MUTEX_TIMED_NO_ELISION_NP, 0, { 0 } } }
# endif
#endif
