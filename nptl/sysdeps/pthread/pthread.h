...
# ifdef __USE_GNU
#  define PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP \
  { { 0, 0, 0, PTHREAD_MUTEX_RECURSIVE_NP, { __PTHREAD_SPINS, 0 } } }
#  define PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP \
  { { 0, 0, 0, PTHREAD_MUTEX_ERRORCHECK_NP, { __PTHREAD_SPINS, 0 } } }
#  define PTHREAD_ADAPTIVE_MUTEX_INITIALIZER_NP \
  { { 0, 0, 0, PTHREAD_MUTEX_ADAPTIVE_NP, { __PTHREAD_SPINS, 0 } } }
#  define PTHREAD_TIMED_ELISION_MUTEX_INITIALIZER_NP \
  { { 0, 0, 0, PTHREAD_MUTEX_TIMED_ELISION_NP, { __PTHREAD_SPINS, 0 } } }
#  define PTHREAD_TIMED_NO_ELISION_MUTEX_INITIALIZER_NP \
  { { 0, 0, 0, PTHREAD_MUTEX_TIMED_NO_ELISION_NP, { __PTHREAD_SPINS, 0 } } }
# endif
#endif
