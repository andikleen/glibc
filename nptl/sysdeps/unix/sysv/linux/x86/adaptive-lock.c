/* Copyright (C) 2011, 2012 Free Software Foundation, Inc.
   ...
   Contributed by Andi Kleen <ak@linux.intel.com>
...
int __lll_adaptive_lock_hle (int *futex, int *try_lock, EXTRAARG int private)
{
  if (*try_lock <= 0) 
    {	
      unsigned status;
